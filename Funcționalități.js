...
b_help = "Text ingrosat (bold): [b]text[/b] (ctrl+b)";
i_help = "Text inclinat: [i]text[/i] (ctrl+i)";
u_help = "Text subliniat: [u]text[/u] (ctrl+u)";
q_help = "Citat: [quote]texte citat[/quote] (ctrl+q)";
c_help = "Afiseaza codul: [code]cod[/code] (ctrl+c)";
l_help = "Lista: [list]text[/list] (ctrl+l)";
o_help = "Lista ordonata: [list=]text[/list] (ctrl+o)";
p_help = "Introdu imagine: [img]http://imagine_url[/img] (ctrl+p)";
w_help = "Introdu un link: [url]http://url[/url] sau [url=http://url]URL text[/url] (ctrl+w)";
a_help = "Inchide toate tag-urile BBCode deschise";
s_help = "Culoare text: [color=red]text[/color] Sfat: puteti folosi si #FF0000";
f_help = "Marime text: [size=x-small]text marunt[/size]";
k_help = "Text ce defileaza: [scroll]text[/scroll] (ctrl+k)";
e_help = "Text sters: [fade]text[/fade] (ctrl+e)";
r_help = "Text neclar: [blur]text[/blur](ctrl+r)";
j_help = "Text inversat: [flipv]text[/flipv] (ctrl+v)";
v_help = "Texte Inversat: [fliph]text[/fliph] (ctrl+j)";
m_help = "Text aliniat la stanga: [left]text[/left] (ctrl+m)";
d_help = "Text ce defileaza de sus in jos: [updown]text[/updown] (ctrl+d)";
t_help = "Text centrat: [center]text[/center] (ctrl+t)";
g_help = "Text aliniat la dreapta: [right]text[/right] (ctrl+g)";
x_help = "Text barat: [strike]text[/strike] (ctrl+x)";
y_help = "Gazduieste o imagine";
z_help = "Introduceti un emoticon in mesajul dvs.";
h_help = "Text vizibil de catre cei care au postat in acest subiect: [hide]text[/hide] (ctrl+h)";
sp_help = "Text ascuns si afisat doar cand se face click deasupra lui: [spoiler]text[/spoiler] (ctrl+o)";
wo_help = "Un obiect World of Warcraft : [wow]17104[/wow]";
ft_help = "Caractere pentru text: [font=Verdana]text[/font]";
jt_help = "Text aliniat: [justify]text[/justify] (ctrl+j)";
sub_help = "Indice: [sub]text[/sub] (ctrl+m)";
sup_help = "Exponent: [sup]text[/sup] (ctrl+n)";
tab_help = "Tabel";
hr_help = "Adauga un rand: text[hr]text";
fl_help = "Introdu animatie flash: [flash(latime, inaltime)]url[/flash]";
vd_help = "Introdu un video (youtube, dailymotion)";
_help = "";
bbcode = new Array();
...
function checkForm() {
    ...
    if (document.post.message.value.length < 3) {
        formErrors = "Trebuie sa scrieti un mesaj inainte de a posta"
    }
    if (formErrors) {
        return false
    } else {
...
function BBcodeVideo(id) {
    ...
    if (url.indexOf('youtube') != '-1' || url.indexOf('youtu.be') != '-1') {
        ...
        span.innerHTML = "URL-ul indicat este invalid:"
    }
}
...
function insert_search_menu(session_id) {
    ...
    document.write('<div id="search_menu" style="display:none;position:absolute;z-index:10000"><form action="' + url_search + '" method="get"><input type="hidden" name="mode" value="searchbox"/><table class="forumline" cellpadding="3" cellspacing="0" border="0"><tr><th class="thHead">Cautare</th></tr><tr><td class="row2" align="center"><input type="text" class="post" name="search_keywords" size="24" style="height:20px;margin-top:6px;margin-right:3px;"/><input type="submit" class="button" value="Go"/></td></tr><tr><td class="row2" align="center" nowrap="nowrap"><span class="genmed">&nbsp;Rezultate pe:&nbsp;<input id="rposts" type="radio" name="show_results" value="posts"/><label for="rposts">&nbsp;Mesaje</label><input id="rtopics" type="radio" name="show_results" value="topics" checked="checked"/><label for="rtopics">&nbsp;Subiecte</label>&nbsp;</span></td></tr><tr><td class="row2" align="center" nowrap="nowrap"><span class="genmed"><label for="rtags">&nbsp;Etichete</label>&nbsp;<input id="rtags" type="checkbox" name="is_tag" value="true"/></span></td></tr><tr><td class="row2" align="center"><span class="genmed"><hr><a href="' + url_search + session_id + '" rel="nofollow" title="Cautare avansata"><img src="https://web.archive.org/web/20171105085052/https://2img.net/i/fa/empty.gif" width="12" height="13" border="0" hspace="3" alt="Cautare avansata"/>&nbsp;Cautare avansata</a></span></td></tr></table>' + session_input + '</form></div>')
}
...
function insert_search_menu_new(session_id) {
    ...
    session_id = (session_id ? '?sid=' + session_id : '');
    url_search = window.url_search || '/search.forum';
    document.write('<div class="overview row3" id="search_menu" style="display:none;position:absolute;width:350px;z-index:10000"><form action="' + url_search + '" method="get"><input type="hidden" name="mode" value="searchbox"/><p class="title-overview row2">Cautare</p><p class="center-overview"><input type="text" class="inputbox medium" name="search_keywords"/>' + session_input + '<input type="submit" class="button1" value="Go"/><br/>Rezultate pe: <label for="rposts"><input id="rposts" type="radio" name="show_results" value="posts"/> Mesaje</label><label for="rtopics"><input id="rtopics" type="radio" name="show_results" value="topics" checked="checked"/> Subiecte</label></p><p class="center-overview"><label for="rtags">Etichete&nbsp;&nbsp;</label><input id="rtags" type="checkbox" name="is_tag" value="true" /></p><hr class="dashed"/><p class="center-overview"><a href="' + url_search + session_id + '" rel="nofollow" title="Cautare avansata"><img src="https://web.archive.org/web/20171105085052/https://2img.net/i/fa/empty.gif" width="12" height="13" alt="Cautare avansata"/> Cautare avansata</a></p>' + session_input + '</form></div>')
}
...
function insert_plus_menu(search_where, session_id, add_favourite) {
    ...
    if (add_favourite) {
        ...
        favourite = '<a rel="nofollow" href="' + url_favourite + '">Adauga la favorite</a><br />'
    }
    ...
    document.write('<a rel="nofollow" href="javascript:showhide(document.getElementById(\'plus_menu\'))">Mai multe optiuni!</a><br /><div id="plus_menu" style="display:none;position:absolute;margin-top:8px;z-index:1;"><table class="forumline" cellpadding="3" cellspacing="0" border="0" width="200"><tr><th class="thHead">Mai multe optiuni!</th></tr><tr><td class="row1" nowrap="nowrap"><span class="gensmall"><b><a rel="nofollow" href="' + url_newposts + '">Mesaje noi</a><br /><a rel="nofollow" href="' + url_egosearch + '">Mesajele proprii</a><br /><a rel="nofollow" href="' + url_unanswered + '">Mesaje la care nu s-a raspuns</a><br /><a href="' + url_watchsearch + '">Subiecte monitorizate</a><hr>' + favourite + '<a rel="nofollow" href="' + self.location.href + '" onclick="link_bbcode();return false">Copiaza adresa BBCode-ului de la pagina</a><br /><a rel="nofollow" href="javascript:void(0);" onclick="window.print();return false">Tipariti aceasta pagina</a></b></span></td></tr></table></div>')
}
...
function insert_plus_menu_new(search_where, session_id, add_favourite, watch_topic) {
    ...
    url_unanswered = window.url_unanswered || ('/search.forum?search_id=unanswered' + search_where + session_id);
    url_watchsearch = window.url_watchsearch || ('/search.forum?search_id=watchsearch' + search_where + session_id);
    document.write('<a rel="nofollow" href="javascript:showhide(document.getElementById(\'plus_menu\'))">Mai multe optiuni!</a><br /><div class="overview row3" id="plus_menu" style="display:none;position:absolute;width:400px;margin-top:8px;z-index:1;"><p class="title-overview row2"><strong>Mai multe optiuni!</strong></p><p class="left-overview"><strong><a rel="nofollow" href="' + url_newposts + '">Mesaje noi</a><br /><a rel="nofollow" href="' + url_egosearch + '">Mesajele proprii</a><br /><a rel="nofollow" href="' + url_unanswered + '">Mesaje la care nu s-a raspuns</a><br /><a rel="nofollow" href="' + url_watchsearch + '">Subiecte monitorizate</a></strong></p><hr class="dashed" /><p class="left-overview"><strong>' + watch + favourite + '<a rel="nofollow" href="' + self.location.href + '" onclick="link_bbcode();return false">Copiaza adresa BBCode-ului de la pagina</a><br /><a rel="nofollow" href="javascript:void(0);" onclick="window.print();return false">Tipariti aceasta pagina</a></strong></p></div>')
}

function insert_plus_album(search_where, session_id) {
    session_id = (session_id ? '&amp;sid=' + session_id : '');
    document.write('<a rel="nofollow" href="javascript:showhide(document.getElementById(\'plus_menu\'))">Mai multe optiuni!</a><br /><div id="plus_menu" style="display:none;position:absolute;right:100px;z-index:1;"><table class="forumline" cellpadding="3" cellspacing="0" border="0"><tr><th class="thHead">Mai multe optiuni!</th></tr></table></div>')
}

function insert_plus_album_new(search_where, session_id) {
    session_id = (session_id ? '&amp;sid=' + session_id : '');
    document.write('<a rel="nofollow" href="javascript:showhide(document.getElementById(\'plus_menu\'))">Mai multe optiuni!</a><br /><div class="overview row3" id="plus_menu" style="display:none;margin: 8px 20px 0px 0px;position:absolute;right:20px;width:200px;z-index:1;"><p class="title-overview row2">Mai multe optiuni!</p></div>')
}
...
function insert_plus_pic_new(search_where, session_id) {
    session_id = (session_id ? '&amp;sid=' + session_id : '');
    document.write('<a rel="nofollow" href="javascript:showhide(document.getElementById(\'plus_menu\'))">Mai multe optiuni!</a><br /><div class="overview row3" id="plus_menu" style="display:none;position:absolute;right:20px;margin-top:20px;z-index:1;"><p class="title-overview row2">Mai multe optiuni!</p></div>')
}
...
function showMenu(event, user, me) {
    ...
    $(div).append('<p class="cb-menu-title"> ' + ((user.username.length > 9) ? user.username.substr(0, 9) + '...' : user.username) + '<span title="Inchide fereastra" class="cb-menu-close" onclick="hideMenu()"> &times; </span>' + '</p>');
    $(div).append("<p class='cb-menu-item'><a href='/u" + user.id + "' target='profile'>Vizualizeaza profilul</a></p>");
    if (user.id != me.id) {
        $(div).append("<p class='cb-menu-item'><a href='/privmsg?mode=post&u=" + user.id + "' target='profile'>Trimite un MP</a></p>")
    }
    if ($("#message").length && me.admin) {
        user.username = user.username.replace(/\\/g, "\\\\").replace(/\'/g, "\\'");
        if (user.chatLevel != 2 && !user.admin) {
            $(div).append("<p class='cb-menu-item'>" + "<a href='#' onclick='return action_user(\"kick\", \"" + user.username + "\");'>Da afara din chat</a>" + "</p>");
            $(div).append("<p class='cb-menu-item'>" + "<a href='#' onclick='return action_user(\"ban\", \"" + user.username + "\");'>Exclude din chat</a>" + "</p>")
        }
        if (user.chatLevel == 2 && user.userLevel != 1 && user.id != me.id) {
            $(div).append("<p class='cb-menu-item'>" + "<a href='#' onclick='return action_user(\"unmod\", \"" + user.username + "\");'>Retrageti drepturile de moderare</a>" + "</p>")
        } else if (!user.admin) {
            $(div).append("<p class='cb-menu-item'>" + "<a href='#' onclick='return action_user(\"mod\", \"" + user.username + "\");'>Adaugare moderator</a>" + "</p>")
        }
    }
    if (connected && user.id == me.id) {
        $(div).append("<p class='cb-menu-item'>" + "<a href='#' onclick='return action_user(\"away\", prompt(\"Motiv\"));'>Absentare</a>" + "</p>");
        $(div).append("<p class='cb-menu-item'>" + "<a href='#' onclick='chatbox.disconnect();hideMenu();'>Iesire</a>" + "</p>")
    }
...
function change_display_by_icon(element, element_id, content_more, content_less, display_special) {
    ...
    element.style.background = 'url(\'' + ((element.className == "icon_less") ? 'https://web.archive.org/web/20171105085052/https://2img.net/i/fa/i/tabs_less.gif' : 'https://web.archive.org/web/20171105085052/https://2img.net/i/fa/i/tabs_more.gif') + '\') no-repeat';
...
function checkreport() {
    ...
    if (!checked) {
        alert('Niciun raport selectat');
        return false
    }
    if (delete_mode) {
        delete_mode = false;
        if (confirm("Sunteti sigur ca doriti sa stergeti raportul/rapoartele?") == true) {
...
function verify_select() {
    ...
    if (selectedfields == 0) {
        msg_error = "Va rugam selectionati cel putin un subiect";
        alert(msg_error);
        return false
    } else {
        return true
...
function google_afs_request_done(google_ads) {
    ...
    if (google_num_ads > 0) {
        if (narrowAds != "") {
            narrowAds = narrowAds + '<a style="text-decoration:none" ' + 'href="https://web.archive.org/web/20171105085052/http://services.google.com/feedback/online_hws_feedback">' + '<div class="ad_header" style="text-align:right">Ads by Google</div></a>'
        }
    }
...
function display_upload_servimg(button, account, id, f) {
    ...
    if (!document.getElementById('obj_servimg')) {
        container.innerHTML = '<p><iframe id="obj_servimg" src="https://web.archive.org/web/20171105085052/https://servimg.com/forum_upload.php?account=' + account + '&id=' + id + '&f=' + f + '" width="540" height="230" border="0" scrolling="no"></iframe></p>'
    }
...
function display_upload_imageshack(button) {
    var container = document.getElementById('servimg_upload_gui');
    if (!document.getElementById('obj_servimg')) {
        container.innerHTML = '<p><iframe src="https://web.archive.org/web/20171105085052/http://imageshack.us/syndicate/widget.php" scrolling="no" allowtransparency="true" frameborder="0" width="300" height="150">Update your browser for ImageShack.us!</iframe></p>'
    }
    var div = document.getElementById('servimg_upload_gui');
    var visible = div.style.visibility;
    if (visible == 'hidden') {
...
function resize_images(o) {
    if ($(document.body).data('image_resize')) {
        ...
        resize_a.href = '#';
        fullsize_a.href = '#';
        $(enlarge_a).addClass('enlarge').text("Mareste aceasta imagine");
        $(resize_a).addClass('resize').text("Redu aceasta imagine");
        $(fullsize_a).addClass('fullsize').text("Click aici pentru a o vizualiza la dimensiunea originala");
...
function FM_widget_share() {
    ...
    content += '<a href="https://twitter.com/share" class="twitter-share-button" data-url="' + urlpage + '" data-count="vertical">Tweet</a><scr' + 'ipt type="text/javascript" src="https://web.archive.org/web/20171105085052/http://platform.twitter.com/widgets.js"></scr' + 'ipt>';
    content += '<iframe src="https://www.facebook.com/plugins/like.php?' + fblang + 'href=' + encodeURIComponent(urlpage) + '&amp;send=false&amp;layout=box_count&amp;width=60&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=60" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:61px; height:61px;" allowTransparency="true"></iframe>';
...
var FA = (function(FA) {
    FA.Lang = {
        'Image_enlarge': "Mareste aceasta imagine",
        'Click_to_resize': "Redu aceasta imagine",
        'Click_to_see_fullsize': "Click aici pentru a o vizualiza la dimensiunea originala"
    };
    return FA
}(FA || {}));
}
